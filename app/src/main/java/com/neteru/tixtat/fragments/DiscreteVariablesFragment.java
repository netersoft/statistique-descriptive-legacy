...
public class DiscreteVariablesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_discrete_variables, container, false);
    ...
    private void addEntry(){
        ...
        @SuppressLint("InflateParams") final View rowView = inflater.inflate(R.layout.var_qtv_d_model, null);
        ...
        if (nb_entries > 1){
            ...
            for (int i = 0; i < nb_entries; i++){
                ...
                if (v instanceof ViewGroup){
                    ...
                    xi[i] = edit1.getText().toString();
                    ni[i] = edit2.getText().toString();
                }
            }
            ...
            Toast.makeText(context, R.string.insufficient_data, Toast.LENGTH_SHORT).show();
        }
    ...
    private void parsing(){
        ...
        if (data != null){
            ...
            String[] xi_tab = data.get(0),
                     ni_tab = data.get(1);

            double[] ni_recup = new double[ni_tab.length];
            double[] xi_recup = new double[xi_tab.length];
            double[] xini_recup = new double[ni_tab.length];
            double[] xi2ni_recup = new double[xi_tab.length];

            double[] up = new double[ni_tab.length];
            double[] down = new double[xi_tab.length];
            ...
            double niMax = 0, upMax = 0, xiMax = 0, xiMin = 0;
            ...
            if (ni_tab.length == xi_tab.length){
                try{
                    ...
                    for (int i = 0;i < ni_tab.length;i++){
                        ...
                        double v2 = xi_recup[i] - (xi_sum / xi_tab.length);
                        ...
                        crXSum += Math.pow(v2, 2);

                        //Recuperation de la somme des (Yi - Y)²
                        crYSum += Math.pow(v1, 2);
                    }

                    //Recuperation des valeurs qui succedent directement à la moitié, au quart et aux 3/4 de la somme des ni
                    ...
                    //Mode
                    modeX = arrondi(xi_recup[indiceNiMax], nb);
                    //Mediane
                    medianeX = arrondi(xi_recup[indiceOperateurMediane], nb);
                    //FirstQuart
                    firstQuartX = arrondi(xi_recup[indiceOperateurFirstQuart], nb);
                    //ThirdQuart
                    thirdQuartX = arrondi(xi_recup[indiceOperateurThirdQuart], nb);
                    //FirstDecile
                    ...
                    ecartX = Math.sqrt(crXSum / (xi_tab.length - 1));
                    ...
                    if (mode.isChecked()){
                        component += "<b><font color='blue'><u>"+getString(R.string.mode)+"</u></font></b><br><br>" +
                                getString(R.string.qtv_d_mode)+"<br>"+
                                "<font color='red'><b><u>Mo = "+noZero(modeX)+"</u></b></font><br><br>";
                    }
                    if (mediane.isChecked()){
                        component += "<b><font color='blue'><u>"+getString(R.string.mediane)+"</u></font></b><br><br>" +
                                getString(R.string.qtv_d_mediane)+"<b>1/2&sum;Ni</b><br>"+
                                "<font color='red'><b><u>Me = "+noZero(medianeX)+"</u></b></font><br><br>";
                    }
                    ...
                    if (courbe.isChecked()){
                        ...
                        defaultSelections.add("bubble");
                        defaultSelections.add("point");

                        Set<String> selections = preferences.getStringSet("graphikA", defaultSelections);
                        ...
                        for (String s: selections){
                            switch (s){
                                case "line":
                                    ...
                                    lineChart.getDescription().setText(getString(R.string.distrib_var_d));
                                ...
                                case "v_bar":
                                    ...
                                    barChart.getDescription().setText(getString(R.string.distrib_var_d));
                                    barChart.invalidate();
                                    break;
                                ...
                                case "h_bar":
                                    ...
                                    horizontalBarChart.getDescription().setText(getString(R.string.distrib_var_d));
                                ...
                                case "bubble":
                                    ...
                                    bubbleChart.getDescription().setText(getString(R.string.distrib_var_d));
                                ...
                                case "point":
                                    ...
                                    scatterChart.getDescription().setText(getString(R.string.distrib_var_d));
                                ...
                                case "line_point":
                                    ...
                                    linePointChart.getDescription().setText(getString(R.string.distrib_var_d));
                    ...
                    componentForSave = "<b><font color='blue'><u>"+getString(R.string.data)+"</u></font></b><br><br><b>Xi :</b> "
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_save:
                ...
                confirmBuilder.setTitle(R.string.save_stats);
                ...
                editText.setHint(R.string.stats_name);
                ...
                confirmDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(view -> {
                    ...
                    if (editText.getText().toString().isEmpty()){
                        ...
                        Toast.makeText(context, R.string.named_this_stats, Toast.LENGTH_SHORT).show();

                    }else {

                        db_manager.db_insertBackup(new Backups(editText.getText().toString(), componentForSave, xi_join.toString(), ni_join.toString()));
                        Toast.makeText(context, R.string.safeguard_done, Toast.LENGTH_SHORT).show();
